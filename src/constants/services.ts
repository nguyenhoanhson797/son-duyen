...
export const addGuest = async (guest: { name: string; email: string; phone: string }) => {
    ...
    try {
      const response = await axios.post('https://wedding-invitation-98d6a.cloudfunctions.net/addGuest', guest);
